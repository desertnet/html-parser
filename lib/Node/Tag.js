...
Foundation.HTML.Parser.Node.Tag = function () {
    Foundation.HTML.Parser.Node.call(this, Foundation.HTML.Parser.Node.Type.TAG);
...
Foundation.HTML.Parser.Node.Tag.prototype.appendChild = function (child) {
    ...
    if (child.type() === Foundation.HTML.Parser.Node.Type.CLOSE) {
    ...
    if (!foundOurClosingTag) {
        Foundation.HTML.Parser.Node.prototype.appendChild.call(this, child);
    }
...
Foundation.HTML.Parser.Node.Tag.prototype.errors = function () {
    var errors = Foundation.HTML.Parser.Node.prototype.errors.call(this);
