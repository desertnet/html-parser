 ...
 * @constructor
 * @param {Foundation.HTML.Parser.Instr} instruction
...
Foundation.HTML.Parser.Op = function (instruction, data) {
    /**
     * @private
     * @type {Foundation.HTML.Parser.Instr}
     */
    ...
    if (data) {
        if (this.instruction() === Foundation.HTML.Parser.Instr.PUSH_NODE) {
            this.setNode(/** @type {Foundation.HTML.Parser.Node} */ (data));
        }
        else if (this.instruction() === Foundation.HTML.Parser.Instr.ADD_TOKEN) {
...
/**
 * Instruction getter.
 * @return {Foundation.HTML.Parser.Instr}
 */
...
Foundation.HTML.Parser.Op.prototype.setToken = function (token) {
    if (this.instruction() !== Foundation.HTML.Parser.Instr.ADD_TOKEN) {
