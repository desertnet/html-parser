 ...
 */
HTMLParser.validate = function (html) {
  if (!Foundation.HTML.Parser.validate._parser) {
    Foundation.HTML.Parser.validate._parser = new HTMLParser();
  }
 ...
 */
HTMLParser.initializeExtraValidations = function () {
 ...
 */
HTMLParser.prototype.compiler = function () {
 ...
 * @private
 */
HTMLParser.prototype.finalize = function () {
 ...
 * @param {string} input
 */
HTMLParser.prototype.setInput = function (input) {
  this._input = input;
 ...
 */
HTMLParser.prototype.executeOp = function (op) {
 ...
 */
HTMLParser.prototype.pushNode = function (node) {
 ...
 * @return {Foundation.HTML.Parser.Node}
 */
HTMLParser.prototype.currentNode = function () {
  if (this._nodes.length === 0) {
 ...
 * @param {Foundation.HTML.Parser.Node} node
 */
HTMLParser.prototype.applyCompletedNode = function (node) {
  switch (node.type()) {
...
HTMLParser.prototype.addClosedElementToParent = function (element) {
 ...
 */
HTMLParser.prototype.popElementsToAndIncluding = function (element) {
  var closedElements = [];
 ...
 */
HTMLParser.prototype.mostRecentOpenElementWithName = function (name) {
 ...
 * @return {Foundation.HTML.Parser.Node.Root}
 */
HTMLParser.prototype.parseTree = function () {
  return this._root;
};
 ...
 * @return {Foundation.HTML.Parser.Node}
 */
HTMLParser.prototype.currentOpenElement = function () {
 ...
 * @return {Foundation.HTML.Parser.Node.Tag}
 */
HTMLParser.prototype.popOpenElement = function () {
 ...
 */
HTMLParser.prototype.pushOpenElement = function (elementNode) {
  this._openElements.unshift(elementNode);
};

window["Foundation"]["HTML"]["Parser"] = HTMLParser;
HTMLParser["validate"] = Foundation.HTML.Parser.validate;
HTMLParser["initializeExtraValidations"] = Foundation.HTML.Parser.initializeExtraValidations;
HTMLParser.prototype["parse"] = HTMLParser.prototype.parse;
